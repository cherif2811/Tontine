...
{
    public partial class Frmretrait_gauche : DevExpress.XtraEditors.XtraUserControl
    {
        public int _iduser;
        public string _codeclient;
        FrmMenu.Menu menu;
        public Frmretrait_gauche(FrmMenu.Menu en)
        {
            InitializeComponent();
            menu = en;
        ...
        private void selection()
        {
            ...
            {
                FrmOperations.Frmretrait_droit frmpa = new FrmOperations.Frmretrait_droit(this);
                XtraTabPage xtraTabPage = new XtraTabPage();
                menu.AddTabControldroit(frmpa, "Saisie rétrait" + gridView1.GetFocusedRowCellValue("codeclt").ToString() + " " + gridView1.GetFocusedRowCellValue("nomclt").ToString() + "" + gridView1.GetFocusedRowCellValue("prenom").ToString() + "", "icons8_Grid.ico");
